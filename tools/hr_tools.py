...
def format_report_tool(content: str, title: str = "HR Intelligence Report") -> str:
    """
    Formats a structured markdown HR report and saves it to outputs/.

    Args:
        content: Markdown body of the report generated by the report writer.
        title:   Report title. Defaults to 'HR Intelligence Report'.
